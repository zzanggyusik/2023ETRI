...
class TrafficSignModel(BehaviorModelExecutor):
    def __init__(self, instance_time, destruct_time, name, engine_name, engine, data_object):
            ...
            self.modelname = "TrafficSignModel"
            self.action_array = []
            self.model = load_model("./model/traffic_sign_model.h5") # h5 file
