...
class PartsModelStand(BehaviorModelExecutor):
    ...
    def ext_trans(self, port, msg):
        if port == SimulationPort.partsModel_start:
            ...
            print(f"Publihsing... : {PartsModelPubPorts.stand.name} {publish_msg}")
            self.publisher.send_string(f"{PartsModelPubPorts.stand.name} {publish_msg}")
